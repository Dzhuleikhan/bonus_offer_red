export const modalTranslations = {
  en: {
    ...
    terms: `I agree to the <a href="#" class="text-white terms-modal-btn underline underline-offset-4" >Terms and Conditions</a></span>`,
  ...
  es: {
    ...
    terms: `<a href="#" class="text-white underline terms-modal-btn underline-offset-4" >Shartlarga</a> roziman</span>`,
  ...
  az: {
    ...
    terms: `<a href="#" class="text-white terms-modal-btn underline underline-offset-4" >Şərtlərlə</a> razıyam</span>`,
  ...
  ua: {
    ...
    signUpBtn: "Roʻyxatdan oʻtish",
    chooseSocialBtn: "Ijtimoiy tarmoqni tanlang",
    terms: `<a href="#" class="text-white terms-modal-btn underline underline-offset-4" >Shartlarga</a> roziman</span>`,
    wrongEmail: "Notoʻgʻri e-mail",
    wrongPassword: "Kamida 6-ta belgidan iborat boʻlishi kerak",
    wrongNumber: "Notoʻgʻri raqam",
    bonusOnNextDeposit: "Keyingi depozit uchun bonus",
  ...
  ru: {
    ...
    terms: `Я соглашаюсь с <a href="#" class="text-white terms-modal-btn underline underline-offset-4" >Условиями и Правилами</a></span>`,
